          ...
          >
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="relative mx-[-1rem] overflow-hidden">
                ...
                <div 
                  className="flex w-full overflow-x-auto no-scrollbar pb-8 pt-2 cursor-grab active:cursor-grabbing px-4 gap-4 md:gap-7"
                  ref={relatedProductsScrollRef}
                  {...relatedProductsScrollHandlers}
                  style={{ WebkitOverflowScrolling: 'touch' }}
                >
                  {[...relatedProducts, ...relatedProducts].map((relatedProduct, idx) => {
                        ...
                        return (
                          <Link
                            key={`${relatedProduct._id || relatedProduct.id}-${idx}`}
